...
const projectImages = ["/portofolio/kasirq.png"];
...
export default function Portfolio() {
    ...
    const getCurrentProjects = () => {
        ...
        return projects.slice(start, start + itemsPerView).map((p, idx) => ({
            ...p,
            image: projectImages[start + idx] || projectImages[0],
        }));
    };
    ...
    return (
        <section id="portfolio" className="py-24 bg-white">
            <div className="mx-auto max-w-6xl px-6 md:px-12">
                <div className="mb-12">
                    <h2 className="text-3xl font-bold text-gray-900">{t.portfolio.heading}</h2>
                    <p className="mt-2 text-gray-600">{t.portfolio.subtitle}</p>
                </div>
